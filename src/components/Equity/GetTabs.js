...
const GetTabs = () => {
    ...
    const tabNames = [
        "Security Summary", "Security Identifier", "Security Details", "Risk",
        "Regulatory Details", "Reference Data", "Pricing Details", "Dividend History"
    ];
    ...
    const fetchDetails = async (tabIndex) => {
        ...
        try {
            ...
            const response = await axios.get(`https://localhost:7248/sm/EquityEquities/GetTabWiseEquity/${tabName}`);
